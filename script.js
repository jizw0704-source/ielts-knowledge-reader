...
const RAW_ARTICLES = [
  ...
  },
  {
    ...
    subtitle: 'Shade, moisture, and planning choices turn trees into active infrastructure during hotter summers.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Environment', 'Public Health', 'Urban Planning'],
    summaryZh: '城市树木并不只是景观元素，它们通过遮阴、蒸腾作用和改善步行环境来缓解热岛效应，并影响公共健康与城市规划。文章讨论树冠覆盖、维护成本、公平分布和长期治理的重要性。',
    summaryEn: 'Urban trees cool cities through shade, evapotranspiration, and better street design, but their benefits depend on maintenance, equitable distribution, and long-term planning.',
    content: [
      `As cities become hotter, trees are increasingly discussed not as decoration but as infrastructure. A row of healthy trees can change how a street feels, how long people are willing to walk, and how much heat nearby surfaces absorb. This matters because modern cities often contain large areas of asphalt, concrete, glass, and dark roofing that store solar energy and release it slowly after sunset. In such places, a district with limited shade may remain uncomfortable long into the evening. Urban trees offer one of the few responses that improve comfort and public health at once.`,
      `The most visible cooling effect comes from shade. When a tree canopy covers a pavement, playground, bus stop, or building wall, less sunlight reaches the surface below. That means the ground absorbs less heat and the surrounding air warms more slowly. In practical terms, shaded routes can feel much safer during extreme heat, especially for older residents and outdoor workers. Shade also protects materials. Benches, railings, and shelters exposed to full sun can become difficult or even dangerous to touch, while shaded versions remain usable for longer periods of the day.`,
      `Trees also cool cities through evapotranspiration, a process that is less visible but scientifically important. Water taken up by roots moves through the tree and eventually leaves the plant through tiny openings in the leaves. As this moisture enters the air, it helps remove heat from the immediate environment. It is not mechanical air conditioning, yet it can make a street or courtyard feel more stable. The combination of shade and evapotranspiration is why two neighbourhoods with similar building density may feel very different if one has mature trees and the other has almost no canopy cover.`,
      `This cooling benefit is closely linked to public health. Heat waves do not affect all residents equally. People with heart or respiratory conditions, those who live in poorly insulated homes, and those who rely on walking or public transport are usually more exposed. Tree cover can lower stress during daily travel by making routes to clinics, shops, schools, and stations more tolerable. It can also make parks and pavements easier to use. In this sense, planting trees is not only an environmental action. It is also a preventive health measure that may reduce the burden on hospitals during prolonged hot weather.`,
      `Yet the value of urban trees depends on planning rather than enthusiasm alone. A tree planted in the wrong place may struggle to survive, damage underground pipes, block visibility, or interfere with power lines. Species choice matters because different trees tolerate drought, wind, pollution, and restricted soil in different ways. Planners therefore have to think about root space, water supply, pruning, biodiversity, and long-term maintenance before they decide what to plant. Some fast-growing species provide early shade but fail under repeated heat stress, while slower species may last longer. Successful tree policy is usually patient rather than symbolic.`,
      `Another issue is fairness. In many cities, wealthier districts have more mature trees, larger gardens, and cooler streets, while lower-income areas have fewer green spaces and more exposed surfaces. This unequal pattern often reflects past planning decisions rather than natural variation. If tree-planting programmes simply follow the easiest or most attractive locations, the cooling benefits may continue to flow toward places that are already comfortable. For that reason, some city governments now map canopy cover together with income, age, health risk, and temperature data. The goal is to direct planting toward neighbourhoods where additional shade will do the most social good rather than the most visual good.`,
      `Maintenance is the part of the story that many public discussions ignore. A newly planted tree cannot cool a city in the same way as a mature one. Young trees need water, protection from traffic, healthy soil, and years of care before they form a broad canopy. If funding ends after the planting ceremony, many trees decline before they provide meaningful benefit. Maintenance is therefore not an optional detail but part of the climate strategy itself. Cities that rely on urban forestry need crews, monitoring systems, and replacement plans, just as they need budgets to maintain roads, drains, and public lighting.`,
      `Trees also work best when they are combined with other cooling measures. A street lined with trees can become more effective if pavements are lighter in colour, if rainwater is directed into planting beds, and if seating, transport stops, and pedestrian crossings are placed within shaded zones. In dense commercial districts, even a small amount of canopy can support broader heat adaptation when it is integrated with reflective materials, reduced traffic idling, and access to drinking water. The lesson is that trees should not be treated as a magical solution. They are most useful when city design allows their environmental benefits to connect with transport, housing, and public space policy.`,
      `For that reason, the role of urban trees in modern cities is larger than it first appears. They alter street temperature, improve comfort, support public health, and help cities respond to heat islands without relying entirely on energy-intensive technology. At the same time, their success depends on planning, fairness, and long-term care. A tree can cool a pavement for decades, but only if a city understands that living infrastructure needs protection as much as concrete infrastructure does. In a hotter century, that understanding may shape whether urban life becomes harsher or more adaptable.`,
    ],
    coreWords: ['urban', 'trees', 'shade', 'evapotranspiration', 'canopy', 'temperature', 'public health', 'infrastructure', 'planning', 'biodiversity', 'maintenance', 'resilience', 'surface', 'microclimate', 'equity'],
    publishDate: '2026-06-26',
  },
  {
    id: 'how-public-libraries-are-changing-in-the-digital-age',
    title: 'How Public Libraries Are Changing in the Digital Age',
    subtitle: 'Libraries are becoming hybrid spaces for digital access, learning support, and community resilience.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Society', 'Technology', 'Education'],
    summaryZh: '公共图书馆正在从安静借阅空间转向兼具数字接入、社区学习、信息公平和公共服务功能的混合型机构。文章讨论数字时代图书馆的变化、价值和限制。',
    summaryEn: 'Public libraries are adapting to the digital age by providing internet access, study space, guidance, community learning, and support for people who face information inequality.',
    content: [
      `Public libraries were once defined mainly by shelves, catalogues, and the quiet exchange of books. In many cities, however, their role has become wider and more complex. A library is now often one of the few public places where people can read, study, use a computer, search for reliable information, and receive help without being expected to buy anything. This change does not mean that books have lost their value. Instead, it shows that access to knowledge now depends on more than printed material. In the digital age, the ability to connect, evaluate information, and learn independently has become a public need.`,
      `The most visible change is digital access. Many services, from job applications to medical appointments and government forms, have moved online. For people with stable internet, this shift may seem efficient. For others, it creates a barrier. Low-income households, older residents, migrants, and students without quiet homes may depend on library computers, Wi-Fi, printers, and staff guidance. In this sense, the library functions as a bridge across information inequality. It helps citizens participate in systems that increasingly assume every person has a device, a connection, and the confidence to use both.`,
      `Libraries also support learning in ways that schools and universities cannot always provide. A student may need a quiet desk after class, an adult may need help learning spreadsheet skills, and a job seeker may need assistance writing a resume. Some libraries offer workshops on digital safety, research methods, local history, language learning, or basic coding. These activities are not a replacement for formal education, but they make learning more continuous. They also reduce the fear that can surround technology, especially for people who feel that digital tools have changed faster than their own skills.`,
      `At the same time, the quiet study space remains important. In crowded housing, shared rooms, or noisy neighbourhoods, concentration can be difficult. A library provides a rare environment where silence is not a luxury product but a public resource. This matters for young people preparing exams, remote workers who cannot afford private offices, and elderly residents who want a calm place to read the news. The design of modern libraries therefore has to balance different forms of use. It may include group rooms, children's areas, computer zones, and silent floors, each serving a different kind of attention.`,
      `The digital transformation of libraries also raises questions about trust. Online information is abundant, but abundance can make judgement harder. Misinformation, advertising, artificial rankings, and unreliable sources can make it difficult for readers to know what to believe. Librarians increasingly act as guides who help users evaluate evidence, compare sources, and understand how information is produced. Their work is less visible than a shelf of books, but it is central to civic life. A community that cannot distinguish reliable knowledge from manipulation is vulnerable, no matter how fast its internet connection may be.`,
      `There are limits to what libraries can achieve. Many operate with small budgets, ageing buildings, and staff who are asked to cover too many roles. Extending digital services requires equipment, maintenance, training, and cybersecurity. It also requires political support, because the value of a library is not always easy to measure in short-term financial terms. Yet the broader social benefit is significant. A strong public library can improve education, reduce exclusion, support local culture, and give residents a shared space in an increasingly commercial city. Its future is not simply digital or traditional. It is hybrid, practical, and deeply connected to the idea that knowledge should remain public.`,
      `The success of this hybrid model depends on design choices that respect both old and new forms of reading. If computers dominate every corner, the library may lose the quiet atmosphere that makes it valuable. If it refuses digital change, it may fail the people who most need help with online systems. The strongest libraries usually treat technology as a tool rather than a replacement for human support. They combine printed collections, digital services, patient staff, and flexible rooms where different kinds of learning can happen side by side. In doing so, they preserve a simple but powerful principle: access to information should not depend entirely on income, confidence, or private space.`,
      `This principle becomes more important as information systems become more complex. A person who cannot complete a form, compare sources, or protect personal data may be excluded from opportunities that appear open in theory. Public libraries cannot remove every barrier, but they can make the digital world less intimidating. Their continuing value lies in this mixture of access, guidance, and trust.`,
    ],
    coreWords: ['library', 'digital access', 'community', 'learning', 'information inequality', 'public space', 'technology', 'education', 'trust', 'knowledge'],
    publishDate: '2026-06-27',
  },
  {
    id: 'why-fungi-matter-to-life-on-earth',
    title: 'Why Fungi Matter to Life on Earth',
    subtitle: 'Fungi recycle matter, connect plants, enrich soil, and supply compounds that influence medicine and food.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Biology', 'Environment', 'Science'],
    summaryZh: '真菌在生态系统中承担分解、土壤更新、植物网络连接和医学应用等多重角色。文章说明真菌为何是地球生命循环中不可忽视的一环。',
    summaryEn: 'Fungi are essential to ecosystems because they decompose organic matter, maintain soil health, connect plant roots, and provide compounds used in medicine and food systems.',
    content: [
      `Fungi are often noticed only when mushrooms appear after rain or when mould grows on forgotten food. Yet these visible forms represent only a small part of a much larger biological kingdom. Most fungi live as networks of fine threads hidden in soil, wood, leaves, or living organisms. They do not fit neatly into the categories people use for plants or animals. They cannot make food from sunlight like plants, but they are not animals either. Instead, they absorb nutrients from their surroundings, and this ability makes them essential to the recycling of life on Earth.`,
      `One of the most important roles of fungi is decomposition. When leaves fall, trees die, or animals leave waste behind, the material does not disappear by itself. Fungi break down complex organic matter into simpler substances that can return to the soil. Without this process, forests and grasslands would be covered with undecomposed remains, and nutrients would be locked away from new growth. Bacteria also take part in decomposition, but fungi are especially effective at breaking down tough materials such as wood. They help turn death into the foundation for further life.`,
      `Fungi also shape soil health. Healthy soil is not just a mixture of minerals and water; it is a living system filled with organisms that influence structure, moisture, and nutrient flow. Fungal threads can bind tiny particles together, improving the soil's ability to hold water and resist erosion. They also move nutrients through spaces that roots cannot easily reach. In agricultural land, this matters because soil that loses its living structure becomes less productive and more dependent on artificial inputs. Understanding fungi therefore helps scientists and farmers think about fertility as an ecological process rather than a simple chemical supply problem.`,
      `The relationship between fungi and plants is especially significant. Many plants form partnerships with mycorrhizal fungi around their roots. In these partnerships, the plant provides sugars produced through photosynthesis, while the fungus helps the plant obtain water and minerals such as phosphorus. The exchange is not always equal, and scientists still debate how much control each partner has, but the relationship can improve survival in difficult conditions. In forests, fungal networks may connect different plants, allowing signals or resources to move through the soil. This does not mean forests behave like a single mind, but it does show that underground cooperation and competition are more complex than they once seemed.`,
      `Human societies have also benefited from fungi in practical ways. Yeasts make bread rise and turn sugars into alcohol. Other fungi contribute to the flavour of cheeses, soy products, and fermented foods. In medicine, fungal compounds have been used to develop antibiotics and other treatments. Penicillin is the most famous example, but it is not the only one. Researchers continue to study fungi for chemicals that may fight infection, reduce disease, or support new industrial processes. The same biological creativity that allows fungi to survive in difficult environments can produce substances useful to humans.`,
      `Fungi can also cause harm. Some species infect crops, damage buildings, or produce toxins. Others threaten amphibians, bats, or trees. This dual role makes fungi difficult to describe in simple terms. They are neither merely helpful nor mainly dangerous. Their importance comes from their position inside ecological systems, where they transform matter, connect organisms, and influence the flow of energy. As climate change alters temperature and moisture patterns, fungal communities may shift in ways that affect forests, farms, and disease. Studying fungi is therefore not a narrow scientific interest. It is a way of understanding how life continues, adapts, and renews itself.`,
      `This perspective is important because fungi are still poorly understood compared with plants and animals. Many species have not been named, and even familiar species may behave differently under changing environmental conditions. A fungus that is harmless in one setting may become damaging when temperature, moisture, or host species change. At the same time, fungal networks may help ecosystems recover after fire, drought, or soil disturbance. Conservation therefore cannot focus only on visible animals and trees. It also has to protect the hidden processes that keep nutrients moving. The more scientists learn about fungi, the clearer it becomes that life on Earth depends on organisms that usually work out of sight.`,
      `For students of ecology, fungi offer a useful lesson about scale. The organisms that hold an ecosystem together are not always large, beautiful, or easy to observe. They may exist as threads beneath a footpath or as spores carried by air. Their quiet activity reminds us that stability is often produced by relationships that remain hidden until they are disturbed.`,
    ],
    coreWords: ['fungi', 'ecosystem', 'decomposition', 'soil', 'nutrient', 'mycorrhizal', 'network', 'medicine', 'organism', 'ecology'],
    publishDate: '2026-06-28',
  },
  {
    id: 'how-sensors-changed-modern-farming',
    title: 'How Sensors Changed Modern Farming',
    subtitle: 'Precision agriculture uses data from fields to guide irrigation, crop monitoring, and resource decisions.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Technology', 'Agriculture', 'Environment'],
    summaryZh: '传感器让现代农业从经验判断走向数据辅助决策。文章讨论土壤湿度、灌溉、作物监测、精准农业以及数据化种植的成本与局限。',
    summaryEn: 'Sensors have changed farming by measuring soil moisture, crop conditions, and environmental variation, allowing farmers to manage water, fertilizer, and risk more precisely.',
    content: [
      `Farming has always depended on observation. A farmer reads the colour of leaves, the weight of soil in the hand, the shape of clouds, and the timing of seasonal change. These skills remain valuable, but modern agriculture increasingly adds another layer: sensors. Small devices placed in fields, greenhouses, machines, or irrigation systems can measure conditions that are difficult to judge by eye. They collect data on soil moisture, temperature, sunlight, humidity, and plant growth. This information can help farmers respond to local variation rather than treating an entire field as if it were the same everywhere.`,
      `The most common example is soil moisture monitoring. Water is one of the most expensive and limited resources in agriculture, especially in dry regions. If a farmer irrigates too little, crops suffer stress and yields may fall. If irrigation is excessive, water is wasted, nutrients may wash away, and roots can become vulnerable to disease. Sensors buried at different depths can show how much water is available to roots and how quickly it is being used. Instead of watering according to a fixed schedule, farmers can make decisions based on actual field conditions. This is one reason precision agriculture is often associated with sustainability.`,
      `Sensors also change crop monitoring. Cameras mounted on drones, tractors, or fixed poles can detect patterns that may not be obvious from ground level. A section of a field may show weaker growth, unusual colour, or early signs of pest damage. Combined with location data, these observations allow farmers to investigate a small area before a problem spreads. In large farms, this can save time because workers do not need to inspect every row with equal attention. In smaller farms, it can help identify problems early enough for a low-cost response. The value of the technology lies not only in measurement but also in timely interpretation.`,
      `Data-driven farming can reduce the use of fertilizer and chemicals. If sensors and mapping tools show that some parts of a field already contain enough nutrients, the farmer may apply less fertilizer there and more where the crop needs it. This targeted approach can lower costs and reduce pollution in nearby rivers or groundwater. Similar principles apply to pest control. Rather than spraying a whole field automatically, farmers can focus on areas where evidence of a threat is strongest. The method is not perfect, but it encourages a shift from routine treatment to informed action.`,
      `However, sensors do not remove uncertainty. Devices can fail, batteries can run out, signals can be weak, and data can be misread. A sensor reading is useful only when it is placed correctly and understood in context. Soil type, crop variety, weather history, and local farming knowledge still matter. There is also the issue of cost. Large farms may invest in sensor networks, software subscriptions, and automated irrigation more easily than small family farms. If the benefits of precision agriculture are available only to wealthy producers, the technology could widen existing inequalities in food systems.`,
      `The most effective use of sensors therefore combines technology with judgement. Farmers need tools that are reliable, affordable, and easy to interpret. They also need training and support, because collecting data is not the same as making a good decision. When used well, sensors can make agriculture more efficient and resilient. They help conserve water, reduce unnecessary inputs, detect problems earlier, and adapt to climate variation. Yet their deeper importance may be cultural. They change farming from a practice based only on seasonal memory to one that joins experience with continuous measurement. The future farm is not simply automated; it is observed more carefully.`,
      `This change also affects the relationship between farmers, advisers, and technology companies. A field may now produce a stream of data that belongs partly to the farmer and partly to the platform that stores or analyses it. Questions about privacy, ownership, and dependence are therefore becoming more important. If farmers cannot repair devices, export data, or understand how recommendations are produced, they may lose control over decisions that once rested on local experience. For sensor-based farming to be genuinely useful, it must remain transparent and adaptable. The best systems strengthen practical knowledge rather than replacing it with instructions from a distant screen.`,
      `The social impact of this shift will depend on who can use the tools. Cooperative purchasing, public advisory services, and open standards may help smaller farms benefit from sensor data without becoming dependent on expensive platforms. In that sense, the future of smart farming is not only about better devices. It is also about fair access to useful knowledge.`,
    ],
    coreWords: ['sensor', 'precision agriculture', 'soil moisture', 'irrigation', 'crop', 'monitoring', 'data', 'resource', 'sustainability', 'variation'],
    publishDate: '2026-06-29',
  },
  {
    id: 'the-hidden-cost-of-urban-noise',
    title: 'The Hidden Cost of Urban Noise',
    subtitle: 'Traffic, construction, and constant sound affect sleep, stress, attention, and public health.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Society', 'Public Health', 'Urban Planning'],
    summaryZh: '城市噪声不仅是烦人的背景音，还会影响睡眠、压力、注意力和公共健康。文章讨论交通、施工、城市规划和不平等暴露带来的隐性成本。',
    summaryEn: 'Urban noise has hidden costs for sleep, stress, attention, and health, and city planning decisions can either reduce or intensify residents exposure to constant sound.',
    content: [
      `Urban noise is often treated as a minor inconvenience, something residents are expected to tolerate in exchange for the benefits of city life. Yet constant sound from traffic, construction, nightlife, aircraft, and machinery can have measurable effects on health and behaviour. Noise is different from many other forms of pollution because it disappears the moment it stops, leaving no visible mark on a wall or street. This invisibility makes it easy to underestimate. However, the body does not ignore sound simply because people become used to it. Even when a person is no longer consciously annoyed, the nervous system may continue to respond.`,
      `Sleep is one of the clearest areas of harm. A loud vehicle passing at night may not fully wake a person, but it can interrupt deeper stages of sleep and reduce recovery. Repeated disturbance can leave residents tired, less patient, and less able to concentrate during the day. Children may struggle with learning, while adults may find work more difficult. In dense cities, the problem is not limited to one dramatic noise. It is often the accumulation of small interruptions: a bus braking, a motorcycle accelerating, a delivery vehicle reversing, or people shouting outside a late-night venue.`,
      `Noise also contributes to stress. The human body evolved to treat sudden sound as possible danger, so repeated exposure can increase alertness even when there is no immediate threat. Over time, this constant state of readiness may influence blood pressure, mood, and mental fatigue. People living near major roads or airports may have fewer opportunities for quiet recovery. They may close windows to block sound, but that can reduce ventilation and increase heat, especially in summer. In this way, noise interacts with other urban pressures rather than existing as a separate problem.`,
      `The burden of urban noise is not equally distributed. Wealthier residents may choose quieter streets, better insulated apartments, or neighbourhoods with more green space. Lower-income households often live closer to highways, industrial areas, rail lines, or busy commercial roads. These locations may also have fewer trees, narrower sidewalks, and older buildings that do little to block sound. The result is an environmental inequality that is rarely discussed in the same terms as air pollution or housing quality. A person's exposure to noise may depend less on personal choice than on income, planning history, and political attention.`,
      `City planning can reduce noise, but it requires more than asking individuals to be patient. Lower speed limits, smoother road surfaces, electric public transport, building insulation, traffic restrictions, and careful zoning can all make a difference. Green spaces can absorb or mask some sound while also providing psychological relief. The design of streets matters as well. A road built mainly for fast vehicles will produce a different sound environment from a street designed for walking, cycling, and public transport. Noise policy is therefore connected to mobility, housing, climate adaptation, and public space.`,
      `Measuring noise is becoming easier as sensors and mapping tools improve. Cities can now identify sound hotspots and compare them with health data, school locations, and housing patterns. The challenge is to turn measurement into action. If the loudest places are also politically weak, data alone will not solve the problem. Urban noise should be understood as a hidden cost of design choices. It affects how people sleep, learn, recover, and relate to their surroundings. A healthier city is not a silent city, but it is one where sound is managed with the same seriousness as traffic flow, air quality, and access to light.`,
      `Public awareness is part of the solution, but it must be handled carefully. Campaigns that ask individuals to be quieter can help in residential areas, yet they cannot substitute for structural change. A delivery worker following a demanding schedule, a bus driver serving a crowded route, or a tenant living beside an old road may have little power to reduce noise alone. Effective policy recognises that sound is produced by systems as well as behaviour. It asks where traffic is routed, how buildings are insulated, when construction is permitted, and whether quiet spaces are available nearby. In that sense, noise control is a form of urban fairness.`,
      `The hidden cost of noise is therefore not only medical but also social. When people cannot rest, talk calmly, or concentrate, public life becomes more strained. Reducing unnecessary sound can make streets more pleasant, homes more restorative, and schools more effective. It is a modest goal compared with building new districts, but it can change daily life in ways residents immediately understand.`,
    ],
    coreWords: ['urban noise', 'public health', 'sleep', 'stress', 'traffic', 'city planning', 'pollution', 'attention', 'inequality', 'measurement'],
    publishDate: '2026-07-01',
  },
  {
    id: 'why-cities-need-quiet-places',
    title: 'Why Cities Need Quiet Places',
    subtitle: 'Quiet spaces such as parks and libraries protect attention, recovery, and public life in noisy cities.',
    sourceType: 'Original IELTS-style Article',
    difficulty: 'IELTS 6.5–7.0',
    tags: ['Society', 'Public Health', 'Urban Planning'],
    summaryZh: '安静空间是城市公共健康和注意力恢复的重要资源。文章讨论公园、图书馆、步行空间和城市规划如何帮助居民从持续噪声中恢复。',
    summaryEn: 'Quiet places are important urban resources because they support attention, recovery, learning, social inclusion, and public health in environments filled with constant sound.',
    content: [
      `Cities are valuable partly because they are active. Streets carry movement, conversation, trade, transport, and cultural life. Yet the same energy can become exhausting when sound is constant and recovery is rare. A city that never offers quiet asks residents to concentrate, rest, study, and think in conditions of continuous interruption. Quiet places are therefore not empty luxuries. They are part of the infrastructure that allows urban life to remain humane. Parks, libraries, courtyards, waterfront paths, and calm pedestrian streets give people a chance to lower their level of alertness and restore attention.`,
      `Attention is a limited resource. In a noisy environment, the brain has to filter traffic, voices, alarms, music, and construction even when a person is trying to focus on something else. This filtering uses mental energy. Over time, it can make reading, problem-solving, or emotional control more difficult. Quiet does not have to mean absolute silence. A space with birdsong, distant conversation, or the sound of leaves may still support concentration because the sounds are softer and less demanding. The key is that the environment should not constantly force the brain to defend itself.`,
      `Public libraries show why quiet places matter socially as well as psychologically. A quiet study room can help students who share crowded homes, adults preparing for exams, job seekers completing applications, and older residents who need a calm place to read. If such spaces exist only in private apartments, clubs, or paid offices, quiet becomes another form of inequality. Public quiet gives people without money or private space access to concentration. It also reminds a city that learning and reflection are collective goods, not merely individual responsibilities.`,
      `Parks and green spaces provide a different kind of quiet. They do not always remove urban sound, but they can soften it and create distance from traffic. Trees, soil, water, and uneven surfaces change how sound travels. They also offer visual relief, shade, and opportunities for slow movement. Research on attention often suggests that natural environments help people recover from mental fatigue because they invite gentle observation rather than forced concentration. A small park may not solve the problem of urban noise, but it can become a daily refuge when it is safe, accessible, and well maintained.`,
      `Designing quiet places requires deliberate planning. A bench beside a major road is not a refuge simply because it is labelled as public space. Location, barriers, planting, surface materials, and traffic management all influence whether a place feels calm. Cities can protect quiet by placing schools, hospitals, libraries, and housing away from the loudest corridors where possible. They can also reduce vehicle speed, restrict unnecessary horns, create car-light streets, and use building layouts that shield courtyards from noise. These choices are practical rather than sentimental. They shape how residents experience their own neighbourhoods.`,
      `There is also a democratic dimension to quiet. People need places where they can think before responding, listen without being overwhelmed, and spend time without commercial pressure. A noisy city may still be exciting, but if every public space is dominated by consumption, traffic, or entertainment, residents lose room for reflection. Quiet places do not make cities less alive. They make urban life more balanced. As density increases and digital devices add another layer of stimulation, the need for calm public environments may become more urgent. A good city should not only move people efficiently; it should also give them somewhere to pause.`,
      `Quiet places are especially important when they are distributed across the city rather than concentrated in wealthy districts. A single famous park may improve a city's image, but daily recovery depends on smaller spaces that people can reach without a long journey. Libraries, shaded courtyards, school gardens, river paths, and protected seating areas can form a network of calm. This network does not need to remove every sound. Its purpose is to create predictable moments of lower pressure within ordinary routines. When such places are safe, welcoming, and free to use, they support mental health in a way that is modest, practical, and deeply public.`,
      `The value of quiet is easy to overlook because it is defined by absence. Planners often count buildings, roads, shops, and visitors more readily than they count relief. Yet relief is part of urban quality. A city that protects attention gives residents more than silence. It gives them the conditions for memory, conversation, patience, and learning to return.`,
      `For this reason, quiet should be planned as carefully as transport, housing, or drainage. It is a small environmental condition with unusually broad consequences for everyday concentration and health.`,
    ],
    coreWords: ['quiet places', 'urban noise', 'public health', 'attention', 'parks', 'libraries', 'city planning', 'recovery', 'public space', 'inequality'],
