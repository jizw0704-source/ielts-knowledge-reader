...
* 已新增 `docs/PHASE\_REVIEW\_V0.3.md`，用于记录 IELTS Knowledge Reader V0.3 阶段复盘。
...
* 
* \- V0.4.0 已完成文章语境释义试点。
* \- 本轮新增 ARTICLE\_CONTEXT\_VOCABULARY，用于支持文章级语境词汇包。
...
* \- 后续建议：
* &#x20; - 继续为其他文章补充 ARTICLE\_CONTEXT\_VOCABULARY；
